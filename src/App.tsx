    ...
    const dynamicDialogueData = [
        {
            id: "start",
            message:
                "Olá, viajante! Tenho uma missão para você. Gostaria de ajudar?",
            options: [
        ...
        <div>
            ...
            {screen === "combat" && (
                <CombatScreen
                    ...
                    attackBonus={
                        playerAttack + (currentEquipment.weapon?.bonus || 0)
                    }
